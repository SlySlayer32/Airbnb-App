...
import { COMPONENT_LIBRARY, getComponentsForRole } from '@airbnb/core-utils';
        ...
        <View style={styles.modalContainer}>
          ...
          <ScrollView style={styles.content}>
            <Text style={styles.description}>
              Choose components to add to your dashboard. Components will
              automatically show role-specific data.
            </Text>
